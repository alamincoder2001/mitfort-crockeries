							...
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-3 no-padding-right">
										<input type="number" step="1" id="quantity" placeholder="Qty" class="form-control" v-model="selectedProduct.pcs" v-on:input="productTotal" onkeydown="moveToNext(event, 'boxQty')" autocomplete="off" required/>
									</div>
									<div class="col-sm-2" style="text-align: right;">
										<label for="boxQty" class="control-label">{{ selectedProduct.Product_SlNo != '' ? selectedProduct.Unit_Name : 'Unit' }}</label>
									</div>
									<div class="col-sm-4">
										<input type="number" class="form-control" id="boxQty" min="0" v-model="selectedProduct.boxQty" v-on:input="productTotal">
									</div>
								</div>
