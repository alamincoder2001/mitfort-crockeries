	...
	<body class="skin-2">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				...
				<!-- Reorder popup Modal -->
				<div id="reOderModal" class="modal fade" role="dialog">
					<div class="modal-dialog modal-lg">
						<!-- Modal content-->
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
								<h4 class="modal-title">Product Reorder List</h4>
							</div>
										...
										<table class="table table-bordered table-condensed">
											...
											<tbody>
												<tr v-for="product in reOrderList">
													...
													<td style="text-align: right;">{{ product.Product_ReOrederLevel }} {{ product.converted_name }}</td>
													<td style="text-align: right;">{{ product.current_quantity }} {{ product.converted_name }}</td>
												</tr>
											</tbody>
										</table>
									</div>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/fancyBox/js/jquery.fancybox.js?v=2.1.5"></script>
	...
	<!-- Popup modal js start  ** by azhar ** -->
	<script src="<?php echo base_url();?>assets/js/vue/vue.min.js"></script>
	<script src="<?php echo base_url();?>assets/js/vue/axios.min.js"></script>

	<script type="text/javascript">
		$(window).on('load', function() {
			var local =  'http://localhost:81/Administrator/';
			var live =  'http://mitfordcrobd.com/Administrator/';
			var pageURL = $(location).attr("href");
			
			if(pageURL == local) {
				$('#reOderModal').modal('show');
			}
		});
	</script>
