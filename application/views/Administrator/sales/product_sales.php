					...
					<div class="row">
						<div class="col-sm-5">
							<div class="form-group clearfix" style="margin-bottom: 8px;">
								...
								<div class="col-xs-8">
									<label for="retail"><input type="radio" id="retail" name="salesType" value="retail" v-model="sales.salesType" v-on:change="onSalesTypeChange"> Retail</label> &nbsp;
									<label for="Wholesale"><input type="radio" name="salesType" value="wholesale" id="Wholesale" v-model="sales.salesType" v-on:change="onSalesTypeChange"> Wholesale </label>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-9">
										<input type="number" id="salesRate" placeholder="Rate" step="0.01" class="form-control" v-model="selectedProduct.Product_SellingPrice" ref="salesRate" onkeydown="moveToNext(event, 'quantity')" v-on:input="productTotal"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 control-label no-padding-right"> Quantity </label>
									<div class="col-xs-4">
										<input type="number" step="0.01" id="quantity" placeholder="Qty" class="form-control" onkeydown="moveToNext(event, 'boxQty')" v-model="selectedProduct.pcs" v-on:input="productTotal" autocomplete="off" required/>
									</div>
									<div class="col-sm-2 no-padding-left">
										<label class="control-label" for="">{{ selectedProduct.Product_SlNo != '' ? selectedProduct.Unit_Name : 'Unit' }}</label>
									</div>
									<div class="col-sm-3 no-padding-left">
										<input type="number" id="boxQty" class="form-control" min="0" v-model="selectedProduct.boxQty" v-on:input="productTotal">
									</div>
								</div>
						...
						<div class="col-sm-2">
							<div style="display:none;" v-bind:style="{display:sales.isService == 'true' ? 'none' : ''}">
								...
								<input type="text" id="stockUnit" v-model="selectedProduct.converted_name" readonly style="border:none;font-size:12px;width:100%;text-align: center;"><br><br>
							</div>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<input type="number" id="Labour" class="form-control" v-model="sales.labourCost" v-on:input="calculateTotal"/>
												</div>
											</div>
										</td>
									</tr>
		...
		methods:{
			...
			async getSales(){
				await axios.post('/get_sales', {salesId: this.sales.salesId}).then(res=>{
					...
					this.sales.labourCost = sales.labourCost;
